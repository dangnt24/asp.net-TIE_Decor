...
namespace TIE_Decor.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var top3product = _context.Products.OrderBy(x => x.Price).Take(3).ToList();
            string top3productJson = JsonConvert.SerializeObject(top3product);
            HttpContext.Session.SetString("Top3Products", top3productJson);
